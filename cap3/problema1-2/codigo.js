...
class Celular
{
    ...
    get infoCelular()
    {
        return (`<br>Color: <b>${this.color}</b>. Peso: <b>${this.peso}kg</b>. Resolucion de pantalla: <b>${this.rp}</b>. 
        <br>Resolucion de camara: <b>${this.rc}</b>. Memoria Ram: <b>${this.ram}</b><br>`);
    }
    encender()
    {
...
document.write(motorolaPremium.infoAltaGama);
document.write(huaweiPremium.infoAltaGama);
